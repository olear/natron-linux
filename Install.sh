...
cat Natron | sed 's#=lib#=/opt/Natron-0.9.4/lib#;s#bin/Natron#/opt/Natron-0.9.4/bin/Natron#' > /usr/bin/Natron || exit 1
cat NatronRenderer | sed 's#=lib#=/opt/Natron-0.9.4/lib#;s#bin/Natron#/opt/Natron-0.9.4/bin/Natron#' > /usr/bin/NatronRenderer || exit 1
