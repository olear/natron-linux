...
yum -y install vixie-cron crontabs python-devel libxslt-devel pango-devel librsvg2-devel libxml2-devel unzip rsync git screen file tree bc devtoolset-1.1 gcc-c++ kernel-devel libX*devel fontconfig-devel freetype-devel zlib-devel *GL*devel *xcb*devel xorg*devel libdrm-devel mesa*devel *glut*devel dbus-devel xz patch bzip2-devel glib2-devel bison flex expat-devel libtool-ltdl-devel || exit 1
