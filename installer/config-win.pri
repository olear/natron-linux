...
boost { INCLUDEPATH += $$quote(C:\local\boost_1_55_032) LIBS += -L$$quote(C:\local\boost_1_55_032\lib) -lboost_serialization-vc100-mt-1_55 }
...
cairo { INCLUDEPATH += $$quote(C:\local\cairo1.12_static_MT_release\include) LIBS += -L$$quote(C:\local\cairo1.12_static_MT_release\lib\x86) -lcairo }
